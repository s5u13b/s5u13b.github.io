...
- Model-ToolChain Team, **Sensetime**, Beijing. (03/2023 - 05/2023)
  ...
  *Intern System Researcher*
  - Contributed to the training and inference optimization of the stable diffusion models on SenseMirage platform.
  - Reproduced the training activation memory compression optimization proposed in Gist (framework presented in *ISCA’18*, not open sourced).
<!--
...
- PaddlePaddle Team, **Baidu**, Beijing. (06/2022 - 09/2022)
  ...
  *Intern R&D Engineer*
  - Participated in the CCF-GLCC Open Source Programming Summer Camp, optimized the max_pool3d and
 depthwise_conv2d_grad operators in the Paddle framework.
  - Achieved performance improvements of 224% and 36% respectively, surpassing PyTorch performance
...
- Platform of Artificial Intelligence, **Alibaba Cloud**, Beijing. (07/2021 - 12/2021)
  ...
  *Intern System Researcher*
  - Contributed to EasyScale, an elastic training system that achieves consistent model accuracy under resource
