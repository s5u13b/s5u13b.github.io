...
I am an AI infrastructure engineer at Qwen Team, Alibaba Group - I work on infrastructure challenges that emerge as LLMs continue to evolve. My recent work focuses on Agentic RL infrastructure for the next-generation Qwen series. Previously, I co-founded [Llumnix](https://github.com/llumnix-project/llumnix), a full-stack solution for distributed LLM inference serving, deployed on [PAI-EAS](https://www.aliyun.com/product/bigdata/learn/eas?spm=a2c4g.11186623.J_XmGx2FZCDAeIy2ZCWL7sW.23.171e1991wxQ2bW&scm=20140722.S_product@@%E4%BA%91%E4%BA%A7%E5%93%81@@2722372._.RL_EAS-LOC_2024NSProductLink-OR_ser-PAR1_213e366217577430627196800e98a7-V_4-RE_productNew-P0_0-P1_0-PAR2_descAbNew) (Alibaba Cloud's online model service platform), evolved from an earlier research prototype, [Llumnix-ray](https://github.com/AlibabaPAI/llumnix) (published at [OSDI'24](https://www.usenix.org/conference/osdi24/presentation/sun-biao)). I also contributed to and maintained [EasyCkpt](https://help.aliyun.com/zh/pai/user-guide/easyckpt), a high-performance asynchronous checkpointing framework for LLM training, accelerating the pre-training of [Qwen2.5](https://arxiv.org/pdf/2412.15115) and [Qwen3](https://arxiv.org/pdf/2505.09388).
...
- Qwen Team, **Alibaba Group**, Hangzhou. *R&D Engineer*. (04/2026 - Present)

- Platform of Artificial Intelligence, **Alibaba Cloud**, Hangzhou. *R&D Engineer*. (07/2024 - 03/2026)
  ...
  - Core contributor of **Llumnix-ray**, a Ray-native dynamic scheduling system for LLM serving. [<i class="fab fa-github"></i> Repo](https://github.com/AlibabaPAI/llumnix) <a href="https://github.com/AlibabaPAI/llumnix/stargazers"><img alt="GitHub stars" src="https://img.shields.io/github/stars/AlibabaPAI/llumnix?style=social" style="display:inline; vertical-align:middle;"></a>
    - Designing architecture, building Ray-based service orchestration and scaling capabilities to enable prefill-decode disaggregation and MoE model deployment, improving system stability and scalability, etc.
  - Contributor and core maintainer of **EasyCkpt**, a high-performance asynchronous checkpointing framework for LLM training, accelerating the pre-training of Qwen2.5 and Qwen3. [<i class="fas fa-book-open"></i> Doc](https://help.aliyun.com/zh/pai/user-guide/easyckpt)
...
<div class='paper-box-text' markdown="1">
- Platform of Artificial Intelligence, **Alibaba Cloud**, Beijing. *Intern Engineer*. (06/2023 - 06/2024)
